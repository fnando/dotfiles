...
# A prettier terminal's ls command, with color and https://www.nerdfonts.com/ icons.
brew "fnando/tap/ll"
# A command-line tool to retrieve secrets from 1Password, with custom output to several formats. Depends on 1Password's own `op` command.
brew "fnando/tap/op-env"
