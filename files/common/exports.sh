...
export PATH="$HOME/local/bin:./node_modules/.bin:./bin:$GEM_HOME/bin:$NPM_HOME/bin:$INSTALL_DIR/ruby/current/bin:$HOME/.bash/bin:$HOME/.zsh/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin"
