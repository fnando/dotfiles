...
export PATH="$HOME/bin:$HOME/local/bin:./bin:$GEM_HOME/bin:$NPM_HOME/bin:$HOME/.bash/bin:$HOME/.zsh/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin:$HOME/.rvm/bin:$HOME/.rbenv/bin"
