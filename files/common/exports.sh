...
export PATH="./node_modules/.bin:./bin:$GEM_HOME/bin:$NPM_HOME/bin:$HOME/local/bin:$HOME/.bash/bin:$HOME/.zsh/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin"
